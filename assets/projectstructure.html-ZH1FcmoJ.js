import{_ as n,c as a,a as e,o as i}from"./app-T9QlsJtF.js";const l={};function c(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="vue3-项目结构" tabindex="-1"><a class="header-anchor" href="#vue3-项目结构"><span>Vue3 项目结构</span></a></h1><p>对于一个标准的 Vue3 项目而言，我们需要先了解它的结构，这样能够帮助我们在使用快速构建的脚手架上搭建我们的项目。</p><p>以下是一个标准的结构。</p><h2 id="结构" tabindex="-1"><a class="header-anchor" href="#结构"><span>结构</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">    vuebox/                   <span class="token comment"># 项目根目录</span></span>
